...
from defines import COLORS, PIXEL_SIZE, BOUNDS
import os
...
class PickPlaceEnv():
  ...
  def __init__(self):
    ...
    assets_path = os.path.dirname(os.path.abspath("")) + "/models"
  ...
  def reset(self, config):
    ...
    self.robot_id = pybullet.loadURDF("/workspace/saycan/models/ur5e/ur5e.urdf", [0, 0, 0], flags=pybullet.URDF_USE_MATERIAL_COLORS_FROM_MTL)
    self.ghost_id = pybullet.loadURDF("/workspace/saycan/models/ur5e/ur5e.urdf", [0, 0, -10])  # For forward kinematics.
    ...
    for obj_name in obj_names:
      if ("block" in obj_name) or ("bowl" in obj_name):
        ...
        if object_type == "block":
          ...
          object_position[2] = 0
          object_id = pybullet.loadURDF("/workspace/saycan/models/bowl/bowl.urdf", object_position, useFixedBase=1)
